          ...
          <div className={profile ? "show" : "hide"}>
            <div className="border-b-2 shadow-lg border-teal-600 shadow-sm bg-neutral-900 text-white shadow-lg p-5 rounded flex flex-col gap-3">
              ...
              <div className="border-b-2 border-neutral-800 text-xl flex gap-1 items-center  px-2 pb-3">
                ...
                <h2 className="font-sans text-white p-1 italic uppercase font-bold">
                  Weather
                  <span className="uppercase font-bold text-teal-500">now</span>
                </h2>
              </div>
              ...
              >
                <LogOut color="#02a9a9" size={16} />{" "}
                <span className="text-xs">Logout</span>
              </button>
              <div>
                <h3 className="text-neutral-500  text-xs flex justify-start italic border-b-2  border-neutral-800 mb-1">
                  History
                </h3>
                <HistoryPage />
              </div>
